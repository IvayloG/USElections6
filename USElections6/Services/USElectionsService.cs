...
{
    public class USElectionsService: IUSElectionsService
    {
        private readonly HttpClient _http;
        private readonly IStateService _stateService;

        public USElectionsService(HttpClient http, IStateService stateService)
        {
            _http = http;
        ...
        public BehaviorSubject<VoteCountResult> PopularVotesRepublican
        {
            get
            {
                if (popularVotesRepublican == null)
                {
                    ...
                    _stateService.CurrentlyChosenYear.Subscribe(async _ => popularVotesRepublican.OnNext(await GetVoteCountResult((int)_stateService.CurrentlyChosenYear.Value, "Republican")));
                }
        ...
        public BehaviorSubject<VoteCountResult> ElectoralVotesRepublican
        {
            get
            {
                if (electoralVotesRepublican == null)
                {
                    ...
                    _stateService.CurrentlyChosenYear.Subscribe(async _ => electoralVotesRepublican.OnNext(await GetVoteCountResult1((int)_stateService.CurrentlyChosenYear.Value, "Republican")));
                }
        ...
        public BehaviorSubject<VoteCountResult> PopularVotesDemocrat
        {
            get
            {
                if (popularVotesDemocrat == null)
                {
                    ...
                    _stateService.CurrentlyChosenYear.Subscribe(async _ => popularVotesDemocrat.OnNext(await GetVoteCountResult((int)_stateService.CurrentlyChosenYear.Value, "Democrat")));
                }
        ...
        public BehaviorSubject<VoteCountResult> ElectoralVotesDemocrat
        {
            get
            {
                if (electoralVotesDemocrat == null)
                {
                    ...
                    _stateService.CurrentlyChosenYear.Subscribe(async _ => electoralVotesDemocrat.OnNext(await GetVoteCountResult1((int)_stateService.CurrentlyChosenYear.Value, "Democrat")));
                }
